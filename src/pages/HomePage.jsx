    ...
    return (
        <>
            <div class="bg-linear-to-b from-[#A8D5E2] to-[#D4F5FF] pt-8 pb-6 px-5 relative overflow-hidden">
                ...
                <h1 className="text-2xl font-bold text-center mb-5 text-[#5A8A9A] relative z-10">🌿 포켓몬 도감</h1>
            </div>
            <div className="p-4">
                <p className="text-xs text-[#8AB5C2] mb-3 font-medium">{pokemons.length}마리</p>
                {/* 목록 */}
